...
```{r define drug categories, eval=FALSE}
...
```{r prepare data with categories, eval=FALSE}
br_data_omop_drugs <- prepareBRDataFromOccurrence(
  observation_period = synpuf_mini$observation_period,
  condition_occurrence = synpuf_mini$condition_occurrence,
  drug_exposure = synpuf_mini$drug_exposure,
  response_event = response_event,
...
```{r run with multiple conditions, eval=FALSE}
response_events = c(
  1, # Something
  2, # Something
  3) # Something

br_data_multiple_conditions <- prepareBRDataFromOccurrence(
  observation_period = synpuf_mini$observation_period,
  condition_occurrence = synpuf_mini$condition_occurrence,
  drug_exposure = synpuf_mini$drug_exposure,
...
br_data_omop_conditions <- prepareBRDataFromOccurrence(
  observation_period = synpuf_mini$observation_period,
  condition_occurrence = synpuf_mini$condition_occurrence,
  drug_exposure = synpuf_mini$drug_exposure,
